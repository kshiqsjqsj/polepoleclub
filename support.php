...
<?php get_header(); ?>
 ...
 <div class="title_img">
  <img src="<?php echo get_template_directory_uri(); ?>/img/support_title.jpg" class="pc tablet" alt="支援参加方法">
  <img src="<?php echo get_template_directory_uri(); ?>/img/support_title_sp.jpg" class="smart" alt="支援参加方法">
 </div>
