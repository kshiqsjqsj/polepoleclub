...
<title><?php bloginfo('name'); ?></title>
	...
	<link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/css/style.css?266548888">
    ...
    <!--ドロワーメニュー-->
				...
				<div class="headerNavi pc">
					<ul>
						...
						<li><a href="<?php echo home_url('/');?>about-us">English</a></li>
					</ul>
				</div>

				<div class="icons pc">
					<ul>
						<li class="button_wrap"><a href="<?php echo home_url('/');?>"  target="_blank" class="button_text"  id="member">会員になる</a></li>
						<li class="button_wrap"><a href="<?php echo home_url('/');?>" target="_blank" class="button_text" id="donation">寄付する</a></li>
